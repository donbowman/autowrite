...
from autowrite.handwriting_synthesis.config import processed_data_path
from autowrite.handwriting_synthesis.training.preparation import get_stroke_sequence, collect_data
